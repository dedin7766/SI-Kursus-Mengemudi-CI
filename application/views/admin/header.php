  ...
  <body>
    <nav class="navbar navbar-default">
      <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">Asyka Stir</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url().'admin/anggota'; ?>"><span class="glyphicon glyphicon-user"></span> Data Member</a></li>
            <li><a href="<?php echo base_url().'admin/transaksi'; ?>"><span class="glyphicon glyphicon-sort"></span> Transaksi Pendaftaran</a></li>
      </ul>
