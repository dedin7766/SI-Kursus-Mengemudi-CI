...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if(isset($_GET['pesan'])){
      if($_GET['pesan']=="gagal"){
        ...
        <div class="panel panel-default">
          <div class="panel-body">
           <center>
            <h2>ASYKA STIR -Pengajar</h2>
            <h3>LOGIN</h2>
            </center>
            <br><br>
            <form method="post" action="<?php echo base_url().'LoginPengajar/login' ?>">
      ...
      <a href="<?php echo base_url().'pengajar/regis_pengajar'; ?>" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus"></span>Registrasi Pengajar</a>
      </div>
