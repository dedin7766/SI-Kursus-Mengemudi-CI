...
<div id="home" class="header">
		<div class="container">
	     <div class="header-top">
	        <div class="logo">
					<a href="index.html"><h1><span>ASYKA</span>STIR</h1></a>
					...
					<div class="h-right">
						...
						<div class="working-hours phone-number">
							...
							<div class="phone-text">
								...
								Hallo,</div>
								<div class="phone-number-number">
								<?=$this->session->userdata('nama_agt')?> </div>
							 </div>
							 <div class="clearfix"> </div>
						 </div>
						 <div class="clearfix"> </div>
            ...
            <?php endif ?>
				    ...
				    <div class="top-menu">
							...
							<ul class="cl-effect-16">
								<li><a class="active" href="<?php echo base_url().'welcome' ?>" data-hover="HOME">Home</a></li> 
								<li><a href="<?php echo base_url().'member/daftar' ?>" data-hover="Daftar">Daftar</a></li>
								<li><a href="<?php echo base_url().'member/pendaftaran' ?>" data-hover="Data Pendaftaran">Data Pendaftaran</a></li>
								<li><a href="<?php echo base_url().'member/konfirmasi' ?>" " data-hover="Data Transaksi">Data Transaksi</a></li>
